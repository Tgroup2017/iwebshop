	...
	<div class="main f_r">
		<div class="box m_10">
			...
			<div class="cont">
				...
				<ul class="newslist">
				<?php foreach($this->helpQuery->find() as $key => $item){?>
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/help/id/".$item['id']."");?>"><?php echo isset($item['name'])?$item['name']:"";?></a>
						<span>(<?php echo date('Y-m-d H:i:s',$item['dateline']);?>)</span>
					</li>
				<?php }?>
				</ul>
