		...
		<?php }else{?>
			...
			<dl class="m_10 clearfix">
				...
				<dd class="w_45">
					...
					<!--图片规格 开始-->
					<div class="item">
						<a href="javascript:void(0);" specName="<?php echo isset($item['name'])?$item['name']:"";?>" specId="<?php echo isset($item['id'])?$item['id']:"";?>" specData="<?php echo isset($spec_value)?$spec_value:"";?>" style="background:url(<?php echo IUrl::creatUrl("")."".$spec_value."";?>) center no-repeat;background-size:contain;"><span></span></a>
					</div>
					<!--图片规格 结束-->
